...
const salesRequestRoutes = require('./routes/salesRequests');
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    const allowedOrigins = process.env.NODE_ENV === 'production'
      ? ['https://inventory-billing-management-system.vercel.app', 'https://0mkzpmk2-3000.inc1.devtunnels.ms', 'http://10.181.0.136:3000', "https://billing.mawinkings.com"]
