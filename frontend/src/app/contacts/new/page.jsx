...
import { ArrowLeft, Plus, User, Phone, Mail, MapPin, FileText, AlertCircle, Hash } from 'lucide-react';
...
export default function AddContactPage() {
    ...
    useEffect(() => {
        // Auto-generate code_name: first 3 letters of name + first 4 digits of phone
        const namePrefix = watchName.slice(0, 3).toUpperCase();
        const phonePrefix = watchPhone.slice(0, 4);
        const generatedCode = namePrefix + phonePrefix;

        if (generatedCode.length > 0) {
            form.setValue('code_name', generatedCode);
        }
                                                        ...
                                                        <FormItem>
                                                            ...
                                                            <FormControl>
                                                                <Input
                                                                    ...
                                                                    {...field}
                                                                    readOnly
                                                                    className="transition-all duration-300 bg-muted"
                                                                />
                                                            </FormControl>
                                                            <FormDescription>
                                                                Auto-generated from name and phone
                                                            </FormDescription>
                                                            <FormMessage />
                                                        </FormItem>
                                                    )}
